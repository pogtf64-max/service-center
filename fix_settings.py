...
def fix_settings():
    """Исправить проблему с settings"""
    print("🔧 Исправляю проблему с settings...")
    ...
    init_content = run_ssh_command("docker exec -i service-center-service-center-1 bash -c 'cd /app && cat routes/__init__.py'")
    print(f"Содержимое routes/__init__.py:\n{init_content.stdout}")
    
    # Создадим правильный routes/__init__.py без settings
...
'''
    ...
    print("📝 Создаю правильный routes/__init__.py...")
